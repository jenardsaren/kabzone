    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-lg bg-white p-4 shadow-sm sm:p-6">
                <h3 class="mb-4 text-lg font-semibold text-gray-900">Today's Assigned Sessions</h3>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($sessions as $session)
                                <tr>
                                    ...
                                    <td class="px-3 py-2">{{ $session->tasks->count() }}</td>
                                    <td class="px-3 py-2">
                                        <a href="{{ route('assistant.sessions.show', $session) }}" class="text-indigo-600 hover:text-indigo-500">Open</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="6" class="px-3 py-6 text-center text-gray-500">No assigned sessions today.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
