    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="gender" name="gender" class="mt-1 block w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                ...
                <option value="male" @selected(old('gender', $user->gender?->value ?? $user->gender) === 'male')>{{ __('Male') }}</option>
                <option value="female" @selected(old('gender', $user->gender?->value ?? $user->gender) === 'female')>{{ __('Female') }}</option>
            </select>
        ...
        <div>
            ...
            <x-text-input id="parent_name" name="parent_name" type="text" class="mt-1 block w-full" :value="old('parent_name', $user->parent_name)" autocomplete="name" />
